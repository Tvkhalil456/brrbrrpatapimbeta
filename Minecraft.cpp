...
DWORD WINAPI MsgBoxThread(LPVOID)
{
    ...
    {
        MessageBoxW(NULL, L"brr brr patapim", L"Erreur", MB_ICONERROR | MB_OK);
        Sleep(5);
    }
    return 0;
}
